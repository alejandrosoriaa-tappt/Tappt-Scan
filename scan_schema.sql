...
-- No contiene imágenes, texto OCR, nombres de archivo, teléfonos ni correo.
-- Sirve al tablero privado /operaciones para medir salud, tiempos y costos.
...
create index if not exists idx_scan_play_metrics_date on scan_play_daily_metrics(metric_date desc);
