...
export const TEXTOS = {
  es: {
    ...
    firmaDespuesDeGuardar: 'Después podrás editar, firmar y ver la ruta en Google Drive.',
  ...
  en: {
    ...
    firmaDespuesDeGuardar: 'Next you can edit, sign, and see its Google Drive location.',
