...
export const TEXTOS = {
  es: {
    ...
    instruccionTerminar: 'Al terminar, toca la palomita para regresar y revisar el documento.',
  ...
  en: {
    ...
    instruccionTerminar: 'When finished, tap the checkmark to return and review the document.',
