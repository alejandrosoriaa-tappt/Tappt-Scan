...
export const TEXTOS = {
  es: {
    ...
    // Bienvenida comercial (se muestra una sola vez)
    bienvenidaDistintivo: 'MÁS QUE UN ESCÁNER',
    bienvenidaTitulo: 'Tus documentos, organizados casi solos.',
    bienvenidaSubtitulo: 'Envía, escanea y encuentra lo importante sin perder tiempo entre fotos, chats y carpetas.',
    bienvenidaFlujoIa: 'IA que organiza',
    bienvenidaWhatsapp: 'Mándalo por WhatsApp',
    bienvenidaWhatsappDetalle: 'Envía una foto como siempre. Tappt se encarga del resto.',
    bienvenidaIa: 'La IA entiende y clasifica',
    bienvenidaIaDetalle: 'Reconoce el documento, extrae sus datos y lo deja fácil de encontrar.',
    bienvenidaDrive: 'Todo aterriza en tu Drive',
    bienvenidaDriveDetalle: 'Ordenado en tus propias carpetas y bajo tu control.',
    bienvenidaContinuar: 'Descubrir Tappt',
    bienvenidaLegal: 'Al continuar aceptas los',
    ...
    recientes: 'Recientes',
    buscarDocumentos: 'Buscar en tus documentos',
    ...
    alineaDocumento: 'Alinea el documento',
    ...
    procesandoSubiendo: 'Subiendo a tu Drive…',
    procesandoEnderezando: 'Enderezando el documento…',
    procesandoClasificando: 'Clasificando con IA…',
    original: 'Original',
    escalaGris: 'Gris',
    blancoYNegro: 'B/N',
    mejorar: 'Mejorar',
    ...
    modoLoteAyuda: 'Modo lote · captura todas las páginas y toca Hecho al terminar.',
    hecho: 'Hecho',
    nuevoEscaneo: 'Nuevo documento',
    paginasEnLote: '{n} página(s)',
    agregar: 'Agregar',
    agregarPagina: 'Agregar página',
    agregarAlLote: 'Agregar al lote',
    guardarCambios: 'Guardar cambios',
    mosaico: 'Mosaico',
    moverIzquierda: 'Mover antes',
    moverDerecha: 'Mover después',
    volverEditor: 'Volver a editar',
    guardarOrden: 'Guardar nuevo orden',
    ...
    formato: 'Formato',
    acciones: 'Acciones',
    editarFirmar: 'Editar documento',
    recortarMejorar: 'Recortar y mejorar',
    guardarVersionMejorada: 'Guardar versión mejorada',
    versionMejoradaGuardada: 'Versión mejorada guardada',
    abriendo: 'Abriendo…',
    abrirEnDrive: 'Abrir en Drive',
    compartir: 'Compartir',
    renombrar: 'Renombrar',
    renombrarDocumento: 'Cambiar nombre',
    nombreDocumento: 'Nombre del documento',
    guardarNombre: 'Guardar nombre',
    nombreInvalido: 'Escribe un nombre para el documento.',
    ...
    documentoGuardado: 'Documento guardado',
    guardadoEnGoogleDrive: 'Ya está seguro en tu Google Drive',
    texto: 'Texto',
    firma: 'Firma',
    emoji: 'Emoji',
    imagen: 'Imagen',
    ...
    guardarYContinuar: 'Guardar PDF y continuar',
    preparandoPdf: 'Preparando PDF…',
    clasificandoDocumento: 'Clasificando documento…',
    guardandoEnDrive: 'Guardando en Drive…',
    guardadoDemasiadoLento: 'El guardado tardó demasiado. Revisa tu conexión e inténtalo de nuevo; el botón ya no quedará bloqueado.',
    firmaDespuesDeGuardar: 'Después podrás editar y ver la ruta en Google Drive.',
    ...
    firmaVacia: 'Dibuja tu firma antes de continuar.',
    eligeColorFirma: '¿De qué color quieres tu firma?',
    vistaMosaico: 'Vista mosaico',
    seleccionar: 'Seleccionar',
    cerrar: 'Cerrar',
    compartirSeleccion: 'Compartir ({n})',
    eliminarSeleccion: 'Eliminar ({n})',
    eliminarPaginas: '¿Eliminar estas páginas?',
    eliminarPaginasDetalle:
      'Se crea una versión nueva sin esas {n} página(s) — el documento original no se toca.',
    noPuedesBorrarTodas: 'No puedes eliminar todas las páginas del documento.',
    listo: 'Listo',
    borrarFirma: 'Borrar y volver a empezar',
    tusFirmas: 'Tus firmas',
    gestionarFirmas: 'Gestionar',
    sinFirmasGuardadas: 'Todavía no tienes firmas guardadas.',
    dibujarFirma: 'Dibujar nueva',
  ...
  en: {
    ...
    bienvenidaDistintivo: 'MORE THAN A SCANNER',
    bienvenidaTitulo: 'Your documents, organized almost by themselves.',
    bienvenidaSubtitulo: 'Send, scan and find what matters without losing time across photos, chats and folders.',
    bienvenidaFlujoIa: 'AI organizes',
    bienvenidaWhatsapp: 'Send it through WhatsApp',
    bienvenidaWhatsappDetalle: 'Share a photo as usual. Tappt takes it from there.',
    bienvenidaIa: 'AI understands and sorts',
    bienvenidaIaDetalle: 'It recognizes the document, extracts key details and makes it easy to find.',
    bienvenidaDrive: 'Everything lands in your Drive',
    bienvenidaDriveDetalle: 'Organized in your own folders and under your control.',
    bienvenidaContinuar: 'Discover Tappt',
    bienvenidaLegal: 'By continuing you accept the',
    ...
    recientes: 'Recent',
    buscarDocumentos: 'Search your documents',
    ...
    alineaDocumento: 'Align the document',
    ...
    procesandoSubiendo: 'Uploading to your Drive…',
    procesandoEnderezando: 'Straightening the document…',
    procesandoClasificando: 'Classifying with AI…',
    original: 'Original',
    escalaGris: 'Gray',
    blancoYNegro: 'B/W',
    mejorar: 'Enhance',
    ...
    modoLoteAyuda: 'Batch mode · capture every page, then tap Done.',
    hecho: 'Done',
    nuevoEscaneo: 'New document',
    paginasEnLote: '{n} page(s)',
    agregar: 'Add',
    agregarPagina: 'Add page',
    agregarAlLote: 'Add to batch',
    guardarCambios: 'Save changes',
    mosaico: 'Grid',
    moverIzquierda: 'Move earlier',
    moverDerecha: 'Move later',
    volverEditor: 'Back to editor',
    guardarOrden: 'Save new order',
    ...
    formato: 'Format',
    acciones: 'Actions',
    editarFirmar: 'Edit document',
    recortarMejorar: 'Crop and enhance',
    guardarVersionMejorada: 'Save enhanced version',
    versionMejoradaGuardada: 'Enhanced version saved',
    abriendo: 'Opening…',
    abrirEnDrive: 'Open in Drive',
    compartir: 'Share',
    renombrar: 'Rename',
    renombrarDocumento: 'Change name',
    nombreDocumento: 'Document name',
    guardarNombre: 'Save name',
    nombreInvalido: 'Enter a name for the document.',
    ...
    documentoGuardado: 'Document saved',
    guardadoEnGoogleDrive: 'It is now safely stored in your Google Drive',
    texto: 'Text',
    firma: 'Signature',
    emoji: 'Emoji',
    imagen: 'Image',
    ...
    deshacer: 'Undo',
    guardarPdf: 'Save PDF',
    guardarYContinuar: 'Save PDF and continue',
    preparandoPdf: 'Preparing PDF…',
    clasificandoDocumento: 'Classifying document…',
    guardandoEnDrive: 'Saving to Drive…',
    guardadoDemasiadoLento: 'Saving took too long. Check your connection and try again; the button will no longer remain stuck.',
    firmaDespuesDeGuardar: 'Next you can edit it and see its Google Drive location.',
    ...
    firmaVacia: 'Draw your signature before continuing.',
    eligeColorFirma: 'What color should your signature be?',
    vistaMosaico: 'Grid view',
    seleccionar: 'Select',
    cerrar: 'Close',
    compartirSeleccion: 'Share ({n})',
    eliminarSeleccion: 'Delete ({n})',
    eliminarPaginas: 'Delete these pages?',
    eliminarPaginasDetalle:
      'A new version is created without those {n} page(s) — the original document stays untouched.',
    noPuedesBorrarTodas: "You can't delete every page in the document.",
    listo: 'Done',
    borrarFirma: 'Clear and start over',
    tusFirmas: 'Your signatures',
    gestionarFirmas: 'Manage',
    sinFirmasGuardadas: "You don't have any saved signatures yet.",
    dibujarFirma: 'Draw new',
