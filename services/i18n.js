...
const MENSAJES = {
  es: {
    bienvenida:
      'Hola, soy Tappt. Mándame la foto de un documento —o reenvíame un PDF— y lo guardo directo en tu Google Drive.',
    sinDrive:
      'Todavía no tienes tu Google Drive conectado. Baja la app de Tappt para conectarlo y guardar tus documentos automáticamente.',
    driveExpirado:
    ...
    guardadoDrive: 'El archivo está seguro en tu Google Drive.',
    botonDrive: 'Abrir en Drive',
    guardadoEditar: 'También puedes abrir este documento directamente en Tappt.',
    botonAbrirApp: 'Abrir en Tappt',
    decisionDocumento: '¿Qué deseas hacer?',
    paginas: ' ({n} páginas)',
    formatoNoSoportado:
    ...
    primeroApp: 'Primero conecta tu cuenta desde la app de Tappt.',
  ...
  en: {
    bienvenida:
      "Hi, I'm Tappt. Send me a photo of a document — or forward me a PDF — and I'll save it straight to your Google Drive.",
    sinDrive:
      "You haven't connected your Google Drive yet. Download the Tappt app to connect it and save your documents automatically.",
    driveExpirado:
    ...
    guardadoEditar: 'You can also open this document directly in Tappt.',
    botonAbrirApp: 'Open Tappt',
    decisionDocumento: 'What would you like to do?',
    paginas: ' ({n} pages)',
    formatoNoSoportado:
    ...
    primeroApp: 'First connect your account from the Tappt app.',
