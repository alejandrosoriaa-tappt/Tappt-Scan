...
<body><main class="c"><h1>Abriendo Tappt…</h1><p>Te llevamos al documento que acabas de guardar.</p><a href="${nativo}">Abrir Tappt</a><p class="s">Si no abre automáticamente, toca el botón.</p></main>
